...
"""
This houses global variables used for plotting, unit conversion, and other constants.
"""
...
GRAVITATIONAL_CONSTANT      = 6.67430e-8     # cm^3 g^-1 s^-2
BOLTZMANN_CONSTANT          = 1.3806e-16     # ergs
EPSILON                     = 1E-7           # small number to avoid zeros
U_to_temp                   = (PROTONMASS / BOLTZMANN_CONSTANT) * (UnitVelocity_in_cm_per_s ** 2)
...
def dust_species_properties(species):
    ...
    - spec_props (dict): A dictionary containing the physical properties of the dust species. The dictionary includes the following keys:
        ...
        - key_abundance (float): The total abundance of the key atom in the dust species.
    ...
    if species == 'silicates':
        ...
        assert 0, "Species type not supported"; return dict()
