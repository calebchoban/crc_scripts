...
def load_snap(sdir, snum, cosmological=0, periodic_bound_fix=True):
    ...
    sp = gizmo_library.snapshot.Snapshot(sdir, snum, cosmological=cosmological, periodic_bound_fix=periodic_bound_fix)

    return sp


# this returns a Particle class
def load_part(sdir, snum, ptype, cosmological=0, periodic_bound_fix=True):
...
def load_header(sdir, snum, ptype, cosmological=0, periodic_bound_fix=True):
...
def load_halo(sdir, snum, cosmological=0, id=-1, mode='AHF', hdir=None, periodic_bound_fix=True):
...
def load_disk(sdir, snum, cosmological=0, id=-1, mode='AHF', hdir=None, periodic_bound_fix=True, rmax=20, height=5):
